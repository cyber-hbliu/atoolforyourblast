...
"Amelia Holt": ("New York", "US", "T", ["electro", "techno", "off-kilter"]),
...
"CCL": ("Berlin / Seattle", "DE", "TJ", ["bass", "psychedelic club", "broken techno"]),
...
"DJ Temporary": ("New York", "US", "H", ["groovy house", "trance"]),
"Downloadable Content": ("", None, "TH", ["techno", "house"]),
"Eden Aurelius": ("New York", "US", "A", ["experimental club", "weightless dub"]),
"Ekkel": ("Oslo", "NO", "T", ["psychedelic trance", "breaks", "nordic electronics"]),
...
"livwutang": ("New York", "US", "HT", ["house", "techno", "dubstep", "electro"]),
...
"Byron Yeates": "Radiant Records", "Ekkel": "Ute.Rec",
...
"RO":"Romania","DK":"Denmark","FI":"Finland","CH":"Switzerland","LU":"Luxembourg","NO":"Norway","ES":"Spain","CO":"Colombia"}
REGION = {"US":"North America","CA":"North America","MX":"North America",
"CO":"South America","JP":"Asia","AU":"Oceania",
"DE":"Europe","GB":"Europe","NL":"Europe","FR":"Europe","RO":"Europe","ES":"Europe","DK":"Europe","FI":"Europe","CH":"Europe","LU":"Europe","NO":"Europe"}
