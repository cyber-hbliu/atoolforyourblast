...
"Ekkel": U,
"Escaflowne": U,
"James K": ("New York", "US", "M", ["vocal", "ambient pop"]),
"Joy Guidry": ("New York", "US", "M", ["bassoon", "free jazz"]),
...
"Malibu": ("Paris", "FR", "M", ["ambient", "vocal"]),
"Matas": ("New York", "US", "T", ["techno"]),
"Mike Midnight": ("Philadelphia", "US", "A", ["leftfield"]),
...
"SPF 50": U,
"Trickpony": ("Montréal", "CA", "H", ["trance-house"]),
